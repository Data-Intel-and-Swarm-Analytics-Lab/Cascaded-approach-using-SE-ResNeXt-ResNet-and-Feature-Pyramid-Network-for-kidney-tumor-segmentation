...
from fpn_resnet import ResnetFPN
from fpn_resnet import fpn_model
...
SAVED_MODEL_PATH = r"C:\Users\HP\Desktop\Project_Implementation\tumor_segmetation\fine_output_model_weights.pth"
TEST_IMAGE_FOR_PREDICTION =  r"O:\preprocess\scan1\img\preprocessed_img_101.png";
IMAGE_FOLDER_PATH = r"O:\preprocess\kidney_dataset\segmented\all_images"
MASK_FOLDER_PATH = r"O:\preprocess\kidney_dataset\all_masks"
SAVE_OUTPUT_FOLDER = r"O:\preprocess\kidney_dataset\fine\segmented";

sigmoid = nn.Sigmoid()
num_output_channels =1
fine_model = fpn_model
loss_fn = nn.BCELoss() 
...
def train_model():
    ...
    # Check for improvement
        if loss < best_value:
            ...
            best_model_state = deepcopy(fine_model.state_dict())
            # Save the best model's state
            torch.save(best_model_state, SAVED_MODEL_PATH)
        if (epoch + 1) % 3 == 0:
            with open('fine_metrics.txt', 'a') as f:
